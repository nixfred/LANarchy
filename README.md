...
[![Version](https://img.shields.io/badge/version-0.16.0-4fc9d6?style=flat-square)](CHANGELOG.md)
...
omarchy-shell lanarchy overrides                    # ignored + named devices
omarchy-shell lanarchy ignore <mac>                 # dismiss a device
omarchy-shell lanarchy restore <mac>                # bring it back
omarchy-shell lanarchy rename <mac> "<name>"        # name it, anchored to the MAC
```
...
| Where | How |
|-------|-----|
| Panel header | `LANARCHY v0.11.0` beside the title |
